...
const WebsiteCounter = () => {
  useEffect(() => {
    ...
    const img = new Image();
    img.src = 'https://www.coolseotools.com/website-visitor-counter/count/&style=style1&show=u&num=9&uid=Dr';
  ...
  return (
    <a href="https://www.coolseotools.com/website-visitor-counter" target="_blank" rel="noopener noreferrer" title="Web Counter">
